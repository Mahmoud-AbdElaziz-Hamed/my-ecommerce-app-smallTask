...
const Footer = () => {
  ...
  const sendBtnClasses = "bg-f37020 p-2 text-white text-md rounded-e-md px-5";
  return (
    <>
      <footer className="bg-[#191919]">
          ...
          <div className="col-span-4 md:col-span-1">
            ...
            <div className="grid  grid-cols-2 mx-auto gap-y-3">
              <div className=" max-w-[240px] ">
                <img src="src/assets/apple_new.png"></img>
              </div>
              <div className=" max-w-[240px] ">
                <img src="src/assets/google_new.png"></img>
              </div>
              <div className=" max-w-[240px] ">
                <img src="src/assets/huawei_new.png"></img>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="grid grid-cols-2 py-5 bg-[#0c0c0c]">
          ...
          <div className="col-span-1 md:col-span-1 ml-12 ">
            <p className="text-white">
              ©Copyright 2023 by Mahmoud ABD ELAZIZ. All Rights Reserved.
            </p>
          </div>
        </section>
      </footer>
